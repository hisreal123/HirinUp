    ...
    <>
      ...
      <div className="relative w-full mt-4 h-fit px-8 pb-2 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300">
        ...
        <div className="flex flex-row justify-center items-center gap-2">
          <Button
            className="group h-auto w-[130px] justify-center border border-transparent transition-all duration-300 flex items-center text-sm font-medium rounded-md bg-primary text-white hover:bg-primary/85"
            disabled={loading}
            onClick={onProceed}
          >
            Next
