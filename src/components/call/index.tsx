              ...
              <div className="m-4">
                ...
                <div className="flex flex-row items-center justify-between mb-2 px-2">
                  <div className="flex flex-col">
                    ...
                    <div
                      className={`text-sm font-bold ${isTimerPaused ? 'text-amber-500' : 'text-black'}`}
                    >
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <div
                      className={`text-sm font-bold ${isTimeUp ? 'text-red-500' : timeLeftSeconds < 60 ? 'text-red-500' : 'text-black'}`}
                    >
